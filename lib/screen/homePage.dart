...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  Future<List<DocumentReference>> _fetchGroups() async {
    ...
    List<DocumentReference> groupList =
        List<DocumentReference>.from(data['group']);
                ...
                body: Column(children: [
                  ...
                  Container(
                    ...
                    child: TabBar(
                      ...
                      tabs: groupsnapshot.data!.asMap().entries.map((entry) {
                                              ...
                                              itemBuilder: (context, index) {
                                                int actualMinutes =
                                                    membersnapshot.data![index]
                                                            ['workout_time']
                                                        ['actual'];
                                                int goalMinutes = membersnapshot
                                                        .data![index]
                                                    ['workout_time']['goal'];
                                                              ...
                                                              child: Column(
                                                                  children: [
                                                                    ...
                                                                    Container(
                                                                      ...
                                                                      decoration:
                                                                        ...
                                                                        image:
                                                                            DecorationImage(
                                                                          image:
                                                                              Image.asset('assets/images/memoticon1.png').image,
                                                                          fit: BoxFit
                                                                              .contain,
                                                                        ),
                                                                      ),
                                                                    ...
                                                                    SizedBox(
                                                                      height: H *
                                                                          0.04,
                                                                      child: membersnapshot.data![index]['status_message'] !=
                                                                              null
                                                                          ? Text(
